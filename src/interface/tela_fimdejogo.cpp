...
// Construtor
tela_fimdejogo::tela_fimdejogo(int pontuacao, int largura_tela_jogo, int altura_tela_jogo)
...
{
    // Desenha o fundo
    al_draw_scaled_bitmap(imagem_fundo, 0, 0, al_get_bitmap_width(imagem_fundo), al_get_bitmap_height(imagem_fundo), 0,
                          0, largura_tela, altura_tela, 0);
...
EstadoProximaTela tela_fimdejogo::getProximaTelaEstado() const { return proxima_tela_estado; }

// Reseta o estado para NENHUM.
void tela_fimdejogo::resetProximaTelaEstado() { proxima_tela_estado = EstadoProximaTela::NENHUM; }