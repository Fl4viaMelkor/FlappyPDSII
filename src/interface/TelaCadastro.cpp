...
//texto
    al_draw_text(fonte_titulo, al_map_rgb(255, 215, 0), centro_x, altura_tela * 0.2f, ALLEGRO_ALIGN_CENTER, "NOVO RECORDE!");
    al_draw_text(fonte_input, al_map_rgb(255, 255, 255), centro_x, altura_tela * 0.4f, ALLEGRO_ALIGN_CENTER, "Digite seu nome:");
    al_draw_text(fonte_input, al_map_rgb(255, 255, 255), centro_x, altura_tela * 0.5f, ALLEGRO_ALIGN_CENTER, nome_jogador.c_str());
    ...
    al_draw_text(fonte_subtext, al_map_rgb(200, 200, 200), centro_x, altura_tela * 0.8f, ALLEGRO_ALIGN_CENTER, "Pressione ENTER para confirmar");
}

void TelaCadastro::step(ALLEGRO_EVENT& evento) {//entrada do teclado
    if (entrada_concluida) return;
...
EstadoProximaTela TelaCadastro::getProximaTelaEstado() const {
    return proxima_tela_estado;
}

void TelaCadastro::resetProximaTelaEstado() {
    proxima_tela_estado = EstadoProximaTela::NENHUM;
}
